$(function() {
	...
	.done(function( data ) {
		$.each( data.items, function( i, item ) {
			var ul = $('#flickr-w'),
				li = '<li><div class="circle small"><figure class="imgLiquidFill"><img src="'+item.media.m+'" alt="flickr-w"></figure><a href="'+item.link+'" target="_blank"><img src="assets/images/plus-icon-small.png" alt="plus-icon-small"></a></div></li>';
			ul.append(li);
			// limit to 9 results
			return i<8;
		});
